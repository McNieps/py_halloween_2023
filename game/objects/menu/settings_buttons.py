...
from game.instances.instance_controls import InstanceControls
from game.instances.instance_audio import InstanceAudio
...
class ControlsButton(Button):
    def __init__(self,
        ...
        self.position = SimplePos((200, 112))

        base_surface = Resource.image["menu"][f"button_controls"]
...
class SoundsButton(Button):
    def __init__(self,
        ...
        self.position = SimplePos((200, 142))

        base_surface = Resource.image["menu"][f"button_audio"]
        surfaces = [base_surface,
                    pygame.surface.Surface(base_surface.get_size(), pygame.SRCALPHA)]
        surfaces[1].blit(surfaces[0], (0, 1))
        self.sprite = AnimatedSprite(surfaces, [1, 0])

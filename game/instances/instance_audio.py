...
from game.objects.menu.button_sounds import SoundsButton
from game.objects.menu.button_return import ReturnButton


class InstanceAudio(BaseInstance):
    font = None
    ...
    async def loop(self):
        self.window.blit(Resource.image["menu"]["board_audio"], (50, 37))
    ...
    def display_volume(self):
        ...
        master_volume = self.font.render(master_volume_str, False, Resource.data["colors"][0])
        ...
        music_volume = self.font.render(music_volume_str, False, Resource.data["colors"][0])
